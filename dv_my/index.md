...
## Harap maklum:
* Selepas menyiapkan langkah berikut, anda hanya perlu mengulangkan langkah 4.2, langkah 5.1 dan langkah 6 setiap kali anda bermain.
* Sila berulang langkah tersebut jika anda bermain di peranti baharu/ selepas menetapkan peranti anda semula.

## 0. Hentikan Windows upate hingga anda siap main game atau acc / game tersebut turun ke trafik rendah (Kamu boleh pause sendiri dekat Windows Update setting):

0.1. Download [Windows Update Pauser reg](https://cutt.ly/JU56Pif) file yang kita bagi:
...
0.2. Jalan file tersebut untuk menghentikan Windows Update sehingga tahun 2099, anda boleh teruskan Windows Update Setting pada masa depan.
