...
### 3. <span style="color: red;">PLEASE PAUSE BOTH THE GAME AND WINDOWS UPDATE AS INSTRUCTED IN THE TUTORIAL FOR THE NEW AND TRENDING GAMES TO AVOID FUTURE ACTIVATION ISSUES!!!</span>
...
Second Note (for disable Game auto update): When Steam force you to update the game after you setup and you decide not to update the game, launch it by the game main exe in the game folder.
