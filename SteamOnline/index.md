...
## Please note:
* After you complete the setup, you only need to do **step 4 & 5** next time you play.
...
5.3. After the game is installed, start the game in online mode, after entered the game main menu, disconnect your internet connection by turn off your wifi or remove the lan cable everytime you play.
